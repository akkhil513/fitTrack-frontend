...
interface DaySchedule { day: string; session: string; muscles: string; badge: string; exercises: Exercise[]; }
...
export class ScheduleComponent implements OnInit {
      ...
      next: (plan: any) => {
        try {
          ...
          const badgeMap: Record<string, string> = {
            'Monday': 'badge-push', 'Tuesday': 'badge-pull',
            'Wednesday': 'badge-legs', 'Thursday': 'badge-push',
            'Friday': 'badge-pull', 'Saturday': 'badge-rest', 'Sunday': 'badge-rest'
          };
  ...
  selectDay(day: DaySchedule) { this.selectedDay.set(day); }
}
